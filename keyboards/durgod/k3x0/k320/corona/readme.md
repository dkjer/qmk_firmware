...
This is a standard off-the-shelf Durgod Taurus K320 Corona TKL (87/88-key) keyboard with a white LED matrix.
...
* Hardware Availability: https://www.amazon.com/Durgod-Taurus-Corona-Mechanical-Keyboard/dp/B07VXR9RY7
...
Make command example for this keyboard (after setting up your build environment):
    ...
    make durgod/k320/corona:default_corona

Flashing example for this keyboard:

    make durgod/k320/corona:default_corona:flash
