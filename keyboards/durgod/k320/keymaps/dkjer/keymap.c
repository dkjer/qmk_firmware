...
# define DEFAULT_LAYOUT _MBL // Change to _WBL to boot into Windows layout.
#endif
#ifndef ALT_LAYOUT
# define ALT_LAYOUT     _WBL // Layout to display 'MR' led when active.
#endif
...
#ifndef APPLE_FN_ENABLE    // If no apple fn support, use custom fn key.
...
// Passthrough GUI desktop control keys if they aren't available.
#ifndef KC_MCON
# define KC_MCON KC_TRNS
#endif
#ifndef KC_LPAD
# define KC_LPAD KC_TRNS
#endif
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WFL] = LAYOUT_tkl_ansi( /* Windows First Layer */
      ...
      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_BTN2,  KC_MS_U,
      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            KC_MS_L,  KC_MS_D,  KC_MS_R,
      _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            KC_BTN2,  KC_BTN1,  KC_MS_U,
      _______,  KC_TGUI,  _______,                                _______,                                _______,  _______,  MO_WSL,   _______,  KC_MS_L,  KC_MS_D,
                                                                                                                                                            KC_MS_R
  ),
  ...
  [_WSL] = LAYOUT_tkl_ansi( /* Windows Second / System Layer */
      ...
      XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_BTN3,  KC_WH_D,
      XXXXXXX,  XXXXXXX,  XXXXXXX,  DEBUG,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            KC_WH_R,  KC_WH_U,  KC_WH_L,
      XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            _______,  KC_BTN3,  KC_WH_D,
      XXXXXXX,  XXXXXXX,  XXXXXXX,                                XXXXXXX,                                XXXXXXX,  _______,  _______,  _______,  KC_WH_R,  KC_WH_U,
                                                                                                                                                            KC_WH_L
  ),
...
#ifdef APPLE_FN_ENABLE   // When Apple Fn key is enable, pass through function row keys to allow OS to manage them.
  /* Keymap _MFL: Mac Function Layer (With Apple Fn Key)
   * ,-----------------------------------------------------------.  ,--------------.
   * |   |    |    |    |    | |    |    |    |    | |  |  |  |  |  |    |    |    |
   * |-----------------------------------------------------------|  |--------------|
   * |   |   |   |   |   |   |   |   |   |   |   |   |   |       |  |    |    |    |
  ...
  [_MFL] = LAYOUT_tkl_ansi( /* Mac First Layer */
      ...
      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            KC_MS_L,  KC_MS_D,  KC_MS_R,
      _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            KC_BTN2,  KC_BTN1,  KC_MS_U,
      _______,  _______,  _______,                                _______,                                _______,  MO_MSL,   _______,  _______,  KC_MS_L,  KC_MS_D,
                                                                                                                                                            KC_MS_R
  ),
#else // When Apple Fn key is not enable, simulate media keys row instead.  Fn + F13/PrtSc will 'lock' media row (TMed).
  /* Keymap _MFL: Mac Function Layer (Without Apple Fn Key)
   * ,-----------------------------------------------------------.  ,--------------.
   ...
   */
  [_MFL] = LAYOUT_tkl_ansi( /* Mac First Layer */
      _______,  KC_BRID,  KC_BRIU,  KC_MCON,  KC_LPAD,  _______,  _______,  KC_MRWD,  KC_MPLY,  KC_MFFD,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_TMED,  _______,  _______,
      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  KC_BTN1,
      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_BTN2,  KC_MS_U,
      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            KC_MS_L,  KC_MS_D,  KC_MS_R,
      _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            KC_BTN2,  KC_BTN1,  KC_MS_U,
  ...
  [_MSL] = LAYOUT_tkl_ansi( /* Mac Second / System Layer */
      RESET,    KC_SLEP,  XXXXXXX,  XXXXXXX,  KC_PWR,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  DF_M2WBL, XXXXXXX,  XXXXXXX,  XXXXXXX,
      XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,  _______,
      XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_BTN3,  KC_WH_D,
      XXXXXXX,  XXXXXXX,  XXXXXXX,  DEBUG,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            KC_WH_R,  KC_WH_U,  KC_WH_L,
      XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            _______,  KC_BTN3,  KC_WH_D,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case KC_TMED:
            ...
            break;
        case KC_MS_U:
            // Mouse direction => Wheel direction when Right Control key is held down.
            if (get_mods() & MOD_BIT(KC_RCTL)) {
                // Reverse the direction, since we usually have 'natural' scrolling on.
                if (record->event.pressed) { register_code(KC_WH_D); }
                else { unregister_code(KC_WH_D); }
                return false;
            }
            break;
        case KC_MS_D:
            ...
            if (get_mods() & MOD_BIT(KC_RCTL)) {
                // Reverse the direction, since we usually have 'natural' scrolling on.
                if (record->event.pressed) { register_code(KC_WH_U); }
                else { unregister_code(KC_WH_U); }
                return false;
            }
            break;
        case KC_MS_L:
            ...
            if (get_mods() & MOD_BIT(KC_RCTL)) {
                // Reverse the direction, since we usually have 'natural' scrolling on.
                if (record->event.pressed) { register_code(KC_WH_R); }
                else { unregister_code(KC_WH_R); }
                return false;
            }
            break;
        case KC_MS_R:
            ...
            if (get_mods() & MOD_BIT(KC_RCTL)) {
                // Reverse the direction, since we usually have 'natural' scrolling on.
                if (record->event.pressed) { register_code(KC_WH_L); }
                else { unregister_code(KC_WH_L); }
                return false;
            }
            break;
        case KC_LGUI:
