...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------|
   * |Ctrl|Alt|Gui|      Space        |Alt|Fn1/Lft|Fn2/Dn|Ctl/Rgt|
   * `-----------------------------------------------------------'
   */
  [0] = LAYOUT_60_ansi(
  ...
  [1] = LAYOUT_60_ansi(
      ...
      KC_CAPS,  KC_LEFT,  KC_DOWN,  KC_RIGHT, _______,  _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, KC_PGUP,  KC_PGDN,            _______,
  ...
  [2] = LAYOUT_60_ansi(
      ...
      _______,  _______,  RGB_VAI,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_HOME,  KC_PGUP,  _______,  _______,
      _______,  RGB_SPD,  RGB_VAD,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  KC_UP,    KC_END,   KC_PGDN,            KC_PGUP,
   ...
   */
  [3] = LAYOUT_60_ansi(
      RESET,    RGB_M_P,  RGB_M_B,  RGB_M_R,  RGB_M_SW, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
